      ...
      {attendanceData.length > 0 && (
        <div className="mt-4 pt-4 border-t space-y-1 text-xs">
          <div className="flex items-center gap-2">
            <span className="h-2 w-2 rounded-full bg-calendar-today"></span>
            <span>Today</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="h-2 w-2 rounded-full bg-calendar-present"></span>
            <span>Present</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="h-2 w-2 rounded-full bg-calendar-leave"></span>
            <span>Leave</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="h-2 w-2 rounded-full bg-calendar-absent"></span>
            <span>Absent</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="h-2 w-2 rounded-full bg-calendar-holiday"></span>
            <span>Holiday</span>
          </div>
        </div>
      )}
